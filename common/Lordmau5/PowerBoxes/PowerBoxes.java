package lordmau5.powerboxes;

import lordmau5.powerboxes.world.blocks.*;
...
import lordmau5.powerboxes.world.item.ItemUpgrade;
import lordmau5.powerboxes.world.item.Items;
import lordmau5.powerboxes.power.LinkBoxNetwork;
...
import lordmau5.powerboxes.world.tileentity.TileEntityPowerCable;
 ...
 */
@Mod(modid = PowerBoxes.modid, dependencies = "required-after:Forge@[9.11.1.942,);after:IC2;after:BuildCraft|Core;after:ComputerCraft")
...
public class PowerBoxes {
    ...
    @Mod.Instance(modid)
    public static PowerBoxes instance;
