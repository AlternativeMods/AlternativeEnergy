...
import lordmau5.powerboxes.world.item.Items;
...
public class BlockPowerBox extends BlockContainer {
    ...
    public BlockPowerBox(int par1, Material par2Material) {
        ...
        setCreativeTab(PowerBoxes.tabPowerBox);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        if(tempTile instanceof TileEntityPowerBox) {
            ...
            if(player.getHeldItem() != null && PowerBoxes.isWrench(player.getHeldItem().itemID) || (!PowerBoxes.BCSupplied && !PowerBoxes.ICSupplied && player.getHeldItem() == null)) {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        icons[0] = par1IconRegister.registerIcon(PowerBoxes.modid + ":" + this.getUnlocalizedName().substring(5) + "_Input");
        icons[1] = par1IconRegister.registerIcon(PowerBoxes.modid + ":" + this.getUnlocalizedName().substring(5) + "_Output");
        icons[2] = par1IconRegister.registerIcon(PowerBoxes.modid + ":" + this.getUnlocalizedName().substring(5) + "_Disabled");
    }
