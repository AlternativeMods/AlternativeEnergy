...
import lordmau5.powerboxes.inventory.slot.InvSlot;
import lordmau5.powerboxes.inventory.slot.InvSlotCharge;
import lordmau5.powerboxes.inventory.slot.InvSlotDisCharge;
...
public class TileEntityPowerBox extends TileEntity implements IInventory, IPeripheral, IEnergyStorage, IEnergySink, IEnergySource, IPowerReceptor {
    ...
    public void fill_chargeSlot() {
        if(!PowerBoxes.ICSupplied || chargeSlot == null)
            return;
    ...
    public void empty_dischargeSlot() {
        if(!PowerBoxes.ICSupplied || dischargeSlot == null)
            return;
