...
public class TileEntityLinkBox extends TileEntity implements IPeripheral, IEnergyStorage, IEnergySink, IEnergySource, IPowerReceptor {
    ...
    public void setLinkId(int linkId) {
        ...
        Main.linkBoxNetwork.removeFromLink(this, getLinkIdentifier(oldLinkedId));
        Main.linkBoxNetwork.addLinkBoxToNetwork(this, getLinkIdentifier());
    ...
    public int getPowerStored() {
        if(linkedId != 0)
            return Main.linkBoxNetwork.getNetworkPower(getLinkIdentifier());
        return storedPower;
    }
    ...
    public void setPowerStored(int power) {
        if(linkedId != 0) {
            Main.linkBoxNetwork.setNetworkPower(getLinkIdentifier(), power);
            return;
        }
    ...
    public int neededPower() {
        if(linkedId != 0)
            return Main.linkBoxNetwork.neededPower(getLinkIdentifier());
    ...
    public void writeToNBT(NBTTagCompound tag) {
        ...
        if(linkedId != 0)
            tag.setInteger("linkId_storedPower", Main.linkBoxNetwork.getNetworkPower(getLinkIdentifier()));
    }
    ...
    public void updateEntity()
    {
        ...
        if(needsToInit) {
            needsToInit = false;
            Main.linkBoxNetwork.addLinkBoxToNetwork(this, getLinkIdentifier());
            Main.linkBoxNetwork.initiateNetworkPower(getLinkIdentifier(), needsToInit_Power);
        }
