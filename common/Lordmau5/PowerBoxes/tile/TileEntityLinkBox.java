...
public class TileEntityLinkBox extends TileEntity implements IPeripheral, IEnergyStorage, IEnergySink, IEnergySource, IPowerReceptor {
    ...
    public void setLinkId(int linkId) {
        ...
        Main.linkBoxNetwork.removeFromLink(this, oldLinkedId);
        Main.linkBoxNetwork.addLinkBoxToNetwork(this, linkedId);
    ...
    public int getPowerStored() {
        if(linkedId != 0)
            return Main.linkBoxNetwork.getNetworkPower(linkedId);
        return storedPower;
    }
    ...
    public int neededPower() {
        if(linkedId != 0)
            return Main.linkBoxNetwork.neededPower(linkedId);
    ...
    public void updateEntity()
    {
        ...
        if(needsToInit) {
            needsToInit = false;
            Main.linkBoxNetwork.addLinkBoxToNetwork(this, linkedId);
            Main.linkBoxNetwork.initiateNetworkPower(linkedId, needsToInit_Power);
        }
